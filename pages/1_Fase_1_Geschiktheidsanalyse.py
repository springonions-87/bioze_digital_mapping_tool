...
def display_intro_text():
    st.markdown("### Fase 1: Geschiktheidsanalyse - Potentiële Locaties voor Grootschalige <placeholder>")
    st.markdown(
        "Bekijk de onderstaande kaarten, elk vertegenwoordigt een vooraf geselecteerd criterium dat essentieel wordt geacht voor het bepalen van de geschiktheid van een gebied voor grootschalige <placeholder>.  "
