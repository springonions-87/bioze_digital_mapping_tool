...
def main():
    ...
    st.markdown("Voor de duidelijkheid: deze tool bestaat puur uit mock data. De tool bestaat uit een ***tweestaps*** leerproces om gebruikers te betrekken bij het leren over de voordelen en afwegingen die gepaard gaan met de plaatsing van grootschalige <placeholder>.")
    ...
    st.markdown("We zullen deze methode gebruiken om te bepalen of een bepaald gebied in de regio geschikt is voor het bouwen van een grootschalige <placeholder>.")
    st.markdown("Aan het einde van deze fase beschikt u over een lijst met kandidaatlocaties voor grootschalige <placeholder>.")
    st.markdown("**Fase 2: Beleidsverkenner**")
    st.markdown("Fase 2 nodigt gebruikers uit om combinaties van kandidaat-locaties voor grootschalige <placeholder> te verkennen om de in de regio <placeholder>.")
    st.markdown("We zullen uw lijst met kandidaatlocaties uit Fase 1 gebruiken om scenario's te genereren die bestaan ​​uit de meest strategische locaties voor <placeholder> om bepaalde doelen te bereiken.")
